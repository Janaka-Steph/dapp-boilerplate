...
contract('HumanStandardToken', function (accounts) {
  ...
  it('events: should fire Transfer event properly', async () => {
    ...
    const transferLog = res.logs.find(element => element.event.match('Transfer') ? true : false)
  ...
  it('events: should fire Approval event properly', async () => {
    ...
    const approvalLog = res.logs.find(element => element.event.match('Approval') ? true : false)
